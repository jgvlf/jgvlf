...
def main():
    ...
    t.toggle_show_cursor(True)
    t.gen_typing_text("jgvlf", 3, contin=True)
    ...
    git_user_details = gifos.utils.fetch_github_stats("jgvlf", ignore_repos)
    user_age = gifos.utils.calc_age(28, 4, 2003)
    t.clear_frame()
    top_languages = [lang[0] for lang in git_user_details.languages_sorted]
    user_details_lines = f"""
    \x1b[30;101mjgvlf@GitHub\x1b[0m
    --------------
    \x1b[96mOS:     \x1b[93mUbunto/Fedora Linux, Windows 11, Android 15\x1b[0m
    \x1b[96mHost:   \x1b[93mRoberto Mange \x1b[94m#SENAI\x1b[0m
    \x1b[96mKernel: \x1b[93mIndustrial Mecatrônic Especialist \x1b[94m#STMI\x1b[0m
    ...
    --------------
    \x1b[96mEmail:      \x1b[93mjoaogabrielvlf@gmail.com\x1b[0m
    \x1b[96mLinkedIn:   \x1b[93mjgvlf\x1b[0m
    ...
    t.gen_typing_text(" -u jgvlf", 1, contin=True)
